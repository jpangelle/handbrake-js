...
class Handbrake extends EventEmitter {
  ...
  */
  ...
  _run () {
    ...
    const spawnArgs = toSpawnArgs(this.options, { optionEqualsValue: true })

    this._emitStart()
    const newCommand = `${this.HandbrakeCLIPath} ${spawnArgs[0]} ${spawnArgs[1].split('=')[0]}='General/Fast 1080p30' ${spawnArgs[2]}`
